...
public class OrganaisationReportGhostingPage {
	public WebDriver driver;
	public int ETO;
	public OrganaisationReportGhostingPage(WebDriver driver , int ETO) {
...
//Ghosting type
	...
	@FindBy(xpath = "//b[contains(text(),'probation period')]/..")
	private WebElement candidateacceptedjobofferandconfirmedjoiningdatebutdidnotjoinandneithercommunicating_dd;
	
	@FindBy(xpath = "//li[@data-value='Candidate accepted job offer and joined then absconded during the probation period']")
	private WebElement candidateacceptedjobofferandjoinedthenabscondedduringtheprobationperiod_dd;
	
	@FindBy(xpath = "//li[@data-value='Candidate accepted job offer and joined then resigned but did not serve notice period under probation period']")
	private WebElement candidateacceptedjobofferandjoinedthenresignedbutdidnotservenoticeperiodunderprobationperiod_dd;
	
	@FindBy(xpath = "//li[@data-value='Employee signed a contractual agreement but subsequently resigned the company without honoring their compensation commitment']")
	private WebElement employeesignedacontractualagreementbutsubsequentlyresignedthecompanywithouthonoringtheircompensationcommitment_dd;
	
	@FindBy(xpath = "//li[@data-value='Employee was working and absconded without any communication']")
	private WebElement employeewasworkingandabscondedwithoutanycommunication_dd;
	
	@FindBy(xpath = "//li[@data-value='Employee was working and resigned but did not serve the notice period']")
	private WebElement employeewasworkingandresignedbutdidnotservethenoticeperiod_dd;
	}
